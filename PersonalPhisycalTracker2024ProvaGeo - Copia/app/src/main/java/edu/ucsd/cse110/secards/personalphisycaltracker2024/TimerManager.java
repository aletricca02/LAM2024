...
public class TimerManager {
    ...
    public void stopTimer(String activity, int Steps, double lati, double longi) {
        if (isRunning) {
            ...
            saveActivityRecord(duration, Steps, lati, longi);
        }
    }

    private void saveActivityRecord(long duration, int Steps, double lati, double longi) {
        LocalDate currentTime = LocalDate.now();
        String datainString  = currentTime.format(formatter);
        ActivityRecord activityRecord = new ActivityRecord(currentActivity, duration, datainString,Steps,lati,longi);
