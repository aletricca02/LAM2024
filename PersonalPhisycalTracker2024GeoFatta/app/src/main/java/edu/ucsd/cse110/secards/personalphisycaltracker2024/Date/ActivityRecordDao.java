...
public interface ActivityRecordDao {
    ...
    @Query("SELECT * FROM activity_records WHERE ABS(:lat - lang) <= :radius AND ABS(:lng - longi) <= :radius")
    List<ActivityRecord> getActivitiesInGeofence(double lat, double lng, double radius);
