...
public class ActivityRecord implements Parcelable {
    ...
    public ActivityRecord(String activityName, long duration, String date, Integer steps, double lang, double longi) {
    ...
    public void setLongi(double longi){this.lang = longi;}
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeInt(steps);
        dest.writeLong((long) longi);
        dest.writeLong((long) lang);
